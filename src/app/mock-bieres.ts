...
export const BIERES: Biere[] = [
    ...
    food_pairing: [
    "Fresh crab with lemon Garlic butter dipping sauce Goats cheese salad Creamy lemon bar doused in powdered sugar"
    ],
    ...
    food_pairing: [
    "Vietnamese squid salad Chargrilled corn on the cob with paprika butter Strawberry and rhubarb pie"
    ],
    ...
    food_pairing: [
    "Mussels with a garlic and herb sauce Crab melt sandwich Shortbread cookies"
    ],
    ...
    food_pairing: [
    "Tandoori lamb with pomegranate Raspberry chocolate torte"
    ],
    ...
    food_pairing: [
    "Kedgeree Scotch broth with sourdough bread Clootie dumpling"
    ],
    ...
    food_pairing: [
    "Warm blackberry pie Vinegar doused fish and chips Aromatic korma curry with lemon and garlic naan"
    ],
    ...
    food_pairing: [
    "Coriander & chilli crab cakes Pistachio cake"
    ],
    ...
    food_pairing: [
    "Coffee dusted venison loin Memphis-style beef short ribs",
    ],
    ...
    image_url: "https://images.punkapi.com/v2/keg.png",
    food_pairing: [
    "Citrus salad with balsamic dressing Lobster Ginger and orange cookies"
    ],
    ...
    food_pairing: [
    "Oysters Hickory smoked ham Rocky Road"
    ],
    ...
    "Pan seared venison fillet with juniper sauce Apricot coconut cake"
    ],
